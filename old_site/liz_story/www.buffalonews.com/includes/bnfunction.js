...
function getRandomLogo()
{
  ...
  logoArry[1] = "../../images/redesign/logo1.gif"
  logoArry[2] = "../../images/redesign/logo2.gif"
  //logoArry[3] = "/images/redesign/logo3.gif"
  logoArry[3] = "../../images/redesign/logo4.gif"
  logoArry[4] = "../../images/redesign/logo5.gif"
  logoArry[5] = "../../images/redesign/logo6.gif"
...
{	
	var win = window.open("", "Picture", "resizable=yes,width=700,height=500"); // a window object
...
function OpenWin(strLocation, strWidth, strHeight)
{
	window.open(strLocation, 'DoubleClick', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width='+strWidth+',height='+strHeight);
}
